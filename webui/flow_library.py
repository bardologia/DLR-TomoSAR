class FlowLibrary:
    ...
    def _processing(self) -> dict:
        nodes = [
            ...
            {"id": "Rhat",    "tex": r"\hat{\mathbf{R}}",      "role": "intermediate", "kind": "matrix", "shape": "N_s x N_s",   "desc": "interferometric sample covariance",        "sample": [["1.0", "0.7"], ["0.7", "1.0"]]},
            ...
            },
            {
                ...
                "lines"   : [
                    [
                        ...
                        {"tex": r"\;\dfrac{"},
                        {"id": "stilde", "tex": r"\overline{\tilde{s}_i}", "role": "intermediate"},
                        {"tex": r"}{\left|s_0\,\overline{\tilde{s}_i}\right|}"},
                    ],
                ],
            },
            {
                ...
                "lines"   : [
                    [
                        {"id": "Rhat", "tex": r"\hat{\mathbf{R}}", "role": "intermediate"},
                        {"tex": "="},
                        {"tex": r"\big\langle\,"},
                        {"id": "phii", "tex": r"\boldsymbol{\phi}", "role": "calculated"},
                        {"tex": r"\,\boldsymbol{\phi}^{H}\big\rangle"},
                    ],
                    [
                        {"id": "Tm", "tex": r"T_m(\xi)", "role": "calculated"},
                        {"tex": r"\;\propto\;"},
                        {"tex": r"\dfrac{1}{\mathbf{a}^{H}(\xi)\,"},
                        {"id": "Rhat", "tex": r"\hat{\mathbf{R}}^{-1}", "role": "intermediate"},
                        {"tex": r"\,\mathbf{a}(\xi)}"},
                    ],
                ],
            },
            ...
            },
            {
                ...
                "lines"   : [
                    [
                        ...
                        {"tex": r"e^{-\frac{(x_h-"},
                        {"id": "mu0", "tex": r"\mu_k", "role": "intermediate"},
                        {"tex": r")^2}{2\sigma_k^2}} -"},
                        {"id": "gtilde", "tex": r"\tilde{\gamma}_h", "role": "intermediate"},
                        {"tex": r"\right)^{2}"},
                    ],
            ...
            },
            {
                ...
                "lines"   : [
                    [
                        ...
                        {"tex": r"\;-\;\eta\,\dfrac{\hat{m}_t}{\sqrt{\hat{v}_t}+\epsilon},\quad g_t = \nabla_{\sigma}"},
                        {"id": "loss", "tex": r"\mathcal{L}", "role": "intermediate"},
                    ],
                ],
            },
            {
                ...
                "lines"   : [
                    [
                        ...
                        {"tex": "="},
                        {"tex": r"\mathrm{MSE}_K\!\big("},
                        {"id": "sigstar", "tex": r"\sigma", "role": "calculated"},
                        {"tex": r"\big) + \lambda_K\,K\,"},
                        {"id": "a0", "tex": r"\bar{a}_K", "role": "intermediate"},
                    ],
                    [
            ...
            },
            {
                ...
                "lines"   : [
                    [
                        ...
                        {"tex": ","},
                        {"id": "sigstar", "tex": r"\sigma", "role": "calculated"},
                        {"tex": r"\,\Big]_{\pi}^{\,k \leq"},
                        {"id": "Kstar", "tex": r"K^{*}", "role": "calculated"},
                        {"tex": r"},\quad \pi=\operatorname{argsort}_k \mu_k"},
                    ],
                ],
            },
            {
                ...
                "lines"   : [
                    [
                        ...
                        {"tex": "="},
                        {"tex": r"1 - \dfrac{\sum_h \big(\hat{\gamma}_h("},
                        {"id": "theta", "tex": r"\theta", "role": "final"},
                        {"tex": r") - \gamma_h\big)^2}{\sum_h (\gamma_h - \bar{\gamma})^2}"},
                    ],
                ],
            },
        ]
    ...
    def _dataset(self) -> dict:
        ...
        steps = [
            ...
            },
            {
                ...
                "lines": [[{"id": "xhat", "tex": r"\hat{\mathbf{x}}", "role": "final"}, {"tex": "="}, {"tex": r"\dfrac{f("}, {"id": "xaug", "tex": r"\mathbf{x}'", "role": "intermediate"}, {"tex": r") - "}, {"id": "stats", "tex": r"\mu_c", "role": "intermediate"}, {"tex": r"}{"}, {"id": "stats", "tex": r"s_c", "role": "intermediate"}, {"tex": r"}"}]],
            },
            {
    ...
    def _training(self) -> dict:
        nodes = [
            ...
            {"id": "err",    "tex": r"e",                       "role": "intermediate", "kind": "vector", "shape": "B x N x P x P",    "desc": "curve-space residual",                       "sample": ["-0.01", "0.01", "-0.02", "..."]},
        ...
        steps = [
            ...
            },
            {
                ...
                "lines": [
                    ...
                    [{"id": "loss", "tex": r"\mathcal{L}", "role": "calculated"}, {"tex": "="}, {"tex": r"\dfrac{\sum_j \mathrm{eff}_j\,\ell_j("}, {"id": "err", "tex": r"e", "role": "intermediate"}, {"tex": r")}{\sum_j \mathrm{eff}_j}"}],
                ],
            },
            {
            ...
            },
            {
                ...
                "lines": [[{"id": "w", "tex": r"\theta_{t+1}", "role": "intermediate"}, {"tex": "="}, {"id": "w", "tex": r"\theta_t", "role": "intermediate"}, {"tex": r"\ -\ \eta\Big(\tfrac{\hat{m}_t("}, {"id": "grad", "tex": r"\mathbf{g}", "role": "intermediate"}, {"tex": r")}{\sqrt{\hat{v}_t}+\epsilon} + \lambda\theta_t\Big)"}]],
            },
            {
                ...
                "inputs": ["w"], "outputs": ["w"],
                "lines": [[{"id": "w", "tex": r"\theta^{\star}", "role": "final"}, {"tex": "="}, {"tex": r"\arg\min_{t}\ \mathcal{L}_{\mathrm{val}}("}, {"id": "w", "tex": r"\theta_t", "role": "intermediate"}, {"tex": r")"}]],
            },
        ]
        return {
    ...
    def _inference(self) -> dict:
        nodes = [
            ...
            {"id": "winv",  "tex": r"w_v",                "role": "intermediate", "kind": "vector", "shape": "P",            "desc": "1D Hann window taper",                      "sample": ["0.10", "0.45", "0.85", "1.00"]},
        ...
        steps = [
            ...
            },
            {
                ...
                "inputs": [], "outputs": ["win"],
                "lines": [
                    [{"id": "winv", "tex": r"w_v[i]", "role": "intermediate"}, {"tex": "="}, {"tex": r"0.5 - 0.5\cos\!\Big(\tfrac{2\pi(i+0.5)}{P}\Big)"}],
            ...
            },
            {
                ...
                "lines": [[{"id": "r2", "tex": r"R^2", "role": "final"}, {"tex": "="}, {"tex": r"1 - \dfrac{\sum ("}, {"id": "cube", "tex": r"\hat{C}", "role": "final"}, {"tex": r" - C)^2}{\sum (C - \bar{C})^2}"}]],
            },
        ]
        return {
    ...
    def _tuning(self) -> dict:
        ...
        steps = [
            ...
            },
            {
                ...
                "lines": [[{"tex": r"\text{prune}\ \iff\ "}, {"id": "fobj", "tex": r"\mathcal{L}^{(t)}_{\mathrm{val}}", "role": "calculated"}, {"tex": r"> \operatorname{median}\big\{\mathcal{L}^{(t)}_{\mathrm{val}}\big\}"}]],
            },
            {
