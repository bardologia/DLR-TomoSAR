...
class ScriptCatalog:
    ...
    META = {
        ...
        "benchmark": {
            ...
            "essentials": ["run_tag", "gpus", "n_gaussians", "sweep_loss_components", "loss.param_matching", "jepa.profile_autoencoder_mode", "jepa.profile_autoencoder_run", "paths.dataset_path", "paths.parameters_path"],
        },
        "cross_validate": {
