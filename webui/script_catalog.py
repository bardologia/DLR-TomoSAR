...
class ScriptCatalog:
    ...
    META = {
        ...
        "train_backbone": {
            ...
            "category"  : "Training",
            "purpose"   : "Train one supervised backbone end to end, or fan out trials across GPUs: loss-curriculum combinations, single-stage losses, physics-loss component and weight sweeps, secondary-track selections, or input-channel ablations.",
        },
