...
class ScriptCatalog:
    ...
    META = {
        ...
        "train_backbone": {
            ...
            "category"  : "Training",
            "purpose"   : "Train one supervised backbone end to end, or fan out trials across GPUs: loss-curriculum combinations, single-stage losses, secondary-track selections, or input-channel ablations.",
        },
