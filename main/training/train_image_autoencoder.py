...
def main() -> None:
    ...
    SeedSweepLauncher(ImageAeEntryConfig(), SingleTrainRunner, "Image autoencoder training", entry_script=pathlib.Path(__file__).resolve(), base_attr="ae_model_name").run()
