...
\begin{frame}{Next steps}
  \begin{itemize}\setlength{\itemsep}{16pt}
    \item \textbf{Physical loss terms}: the five ranked terms and the first single-term $K{=}2$ sweep results on the next six frames; the Capon-cycle arm is still queued.
...
\begin{frame}{The $K{=}2$ physics by scatterer count --- the scatterer set is untouched}
    \centering
  \scriptsize
  ...
  \begin{tabular}{@{}l cccccc@{}}
    \toprule
    & \multicolumn{6}{c@{}}{physics term at its weight} \\
    \cmidrule(l){2-7}
    metric & none & coh.\ $w{=}0.25$ & coh.\ $w{=}1$ & mom.\ $w{=}0.05$ & cov.\ $w{=}0.05$ & pow.\ $w{=}0.05$ \\
    \midrule
    precision $\uparrow$ & \seedpm{0.895}{.008} & \seedpm{0.892}{.009} & \seedpm{0.870}{.045} & \seedpm{0.896}{.005} & \seedpm{0.899}{.005} & \seedpm{0.897}{.003} \\
    \quad $k{=}1$ & \seedpm{0.935}{.010} & \seedpm{0.932}{.011} & \seedpm{0.902}{.067} & \seedpm{0.937}{.006} & \seedpm{0.938}{.006} & \seedpm{0.938}{.003} \\
    \quad $k{=}2$ & \seedpm{0.828}{.006} & \seedpm{0.826}{.006} & \seedpm{0.818}{.009} & \seedpm{0.828}{.006} & \seedpm{0.834}{.003} & \seedpm{0.831}{.004} \\
    \addlinespace
    recall $\uparrow$ & \seedpm{0.901}{.001} & \seedpm{0.903}{.002} & \seedpm{0.903}{.001} & \seedpm{0.902}{.001} & \seedpm{0.902}{.001} & \seedpm{0.900}{.001} \\
    \quad $k{=}1$ & \seedpm{0.999}{.000} & \seedpm{0.999}{.000} & \seedpm{0.999}{.000} & \seedpm{0.999}{.000} & \seedpm{0.999}{.000} & \seedpm{0.999}{.000} \\
    \quad $k{=}2$ & \seedpm{0.763}{.002} & \seedpm{0.766}{.004} & \seedpm{0.768}{.001} & \seedpm{0.764}{.003} & \seedpm{0.763}{.003} & \seedpm{0.761}{.003} \\
    \addlinespace
    \multicolumn{7}{@{}l}{\emph{count acc $\mid$ pred $k$}} \\
    \quad pred $k{=}1$ $\uparrow$ & \seedpm{0.944}{.004} & \seedpm{0.948}{.006} & \seedpm{0.954}{.002} & \seedpm{0.944}{.005} & \seedpm{0.943}{.002} & \seedpm{0.941}{.001} \\
    \quad pred $k{=}2$ $\uparrow$ & \seedpm{0.814}{.024} & \seedpm{0.808}{.023} & \seedpm{0.755}{.122} & \seedpm{0.817}{.015} & \seedpm{\textbf{0.819}}{.015} & \seedpm{0.819}{.007} \\
    \addlinespace
    $\mu$ MAE $\downarrow$ & \seedpm{1.71}{.07} & \seedpm{1.72}{.06} & \seedpm{1.81}{.12} & \seedpm{1.69}{.04} & \seedpm{\textbf{1.65}}{.02} & \seedpm{1.67}{.03} \\
    \quad $k{=}1$ & \seedpm{0.36}{.01} & \seedpm{0.35}{.00} & \seedpm{0.35}{.00} & \seedpm{0.35}{.01} & \seedpm{0.35}{.01} & \seedpm{0.35}{.00} \\
    \quad $k{=}2$ & \seedpm{3.78}{.14} & \seedpm{3.82}{.13} & \seedpm{4.02}{.26} & \seedpm{3.75}{.09} & \seedpm{\textbf{3.66}}{.05} & \seedpm{3.72}{.08} \\
    \addlinespace
    $\sigma$ MAE $\downarrow$ & \seedpm{0.774}{.011} & \seedpm{0.778}{.011} & \seedpm{0.809}{.020} & \seedpm{0.771}{.018} & \seedpm{\textbf{0.754}}{.007} & \seedpm{0.761}{.005} \\
    \quad $k{=}1$ & \seedpm{0.193}{.002} & \seedpm{0.192}{.003} & \seedpm{0.194}{.006} & \seedpm{0.195}{.003} & \seedpm{0.194}{.002} & \seedpm{0.194}{.003} \\
    \quad $k{=}2$ & \seedpm{1.668}{.023} & \seedpm{1.675}{.016} & \seedpm{1.737}{.035} & \seedpm{1.657}{.043} & \seedpm{\textbf{1.620}}{.017} & \seedpm{1.639}{.015} \\
    \addlinespace
    $a$ MAE $\downarrow$ & \seedpm{0.182}{.004} & \seedpm{0.182}{.005} & \seedpm{0.185}{.006} & \seedpm{0.182}{.003} & \seedpm{0.187}{.005} & \seedpm{0.184}{.004} \\
    \quad $k{=}1$ & \seedpm{\textbf{0.058}}{.003} & \seedpm{0.058}{.004} & \seedpm{0.061}{.008} & \seedpm{0.058}{.003} & \seedpm{0.061}{.004} & \seedpm{0.059}{.004} \\
    \quad $k{=}2$ & \seedpm{0.373}{.006} & \seedpm{0.373}{.005} & \seedpm{0.373}{.004} & \seedpm{0.372}{.002} & \seedpm{0.381}{.007} & \seedpm{0.377}{.004} \\
    \bottomrule
    \end{tabular}
  \par\vspace{2pt}
  \parbox{0.86\textwidth}{\tiny\color{soft} \textbf{runs}: dual UNet-skip trunks $\cdot$ set-pred $\cdot$ Hungarian
   $\cdot$ $K{=}2$ $\cdot$ presence A $\cdot$ full norm ladder $\cdot$ hv flips
   $\cdot$ patch $64{\times}32$ $\cdot$ fixed routing (full stack $\to$ both
   trunks) $\cdot$ parity twins. Column $=$ physics
   term at its best-scoring weight, plus the $w{=}1$ coherence arm; none $=$ the
   no-physics reference. All rows matched (Hungarian pairing); cells mean $\pm$ seed
   std over five seeded replicas; held-out test; $k$ $=$ true scatterer count of the
   pixel; component errors over matched pairs only. \textbf{bold} $=$ best in row,
   marked only where best and worst differ by more than $5\%$ --- almost nothing
   clears it: detection, count calibration and component errors all sit inside
   combined seed noise, so the physics terms shape the profile, not the scatterer
   set. The one exception is full-weight coherence: its wider gate pays $\mu$/$\sigma$
   ($\mu$ 1.71 $\to$ 1.81, $\sigma$ 0.774 $\to$ 0.809) and destabilises the claimed
   pairs (pred $k{=}2$ acc $\pm$.122). Precision rewards under-prediction --- rank on
   recall. count acc $\mid$ pred $k$: share of pixels claiming exactly $k$ scatterers
   whose true count is $k$. $\mu$, $\sigma$ in elevation units; $a$ in linear
   amplitude.\par}
\end{frame}
...
\begin{frame}{The $K{=}2$ physics per-pixel tail --- descriptor and covariance terms cap the blow-ups}
  ...
  \begin{tabular}{@{}l cccccc@{}}
    ...
    metric & none & coh.\ $w{=}0.25$ & coh.\ $w{=}1$ & mom.\ $w{=}0.05$ & cov.\ $w{=}0.05$ & pow.\ $w{=}0.05$ \\
    \midrule
    \multicolumn{7}{@{}l}{\emph{curve level}} \\
    \quad curve $R^2$ $\uparrow$ & \seedpm{0.747}{.006} & \seedpm{0.755}{.007} & \seedpm{0.751}{.008} & \seedpm{0.755}{.002} & \seedpm{0.748}{.001} & \seedpm{0.751}{.005} \\
    \quad curve MAE $\downarrow$ & \seedpm{0.0370}{.0005} & \seedpm{0.0366}{.0003} & \seedpm{0.0371}{.0007} & \seedpm{0.0365}{.0002} & \seedpm{0.0365}{.0002} & \seedpm{0.0366}{.0001} \\
    \quad RMSE $\downarrow$ & \seedpm{0.217}{.002} & \seedpm{0.213}{.003} & \seedpm{0.215}{.003} & \seedpm{0.214}{.001} & \seedpm{0.217}{.000} & \seedpm{0.215}{.002} \\
    \quad PSNR [dB] $\uparrow$ & \seedpm{52.63}{.10} & \seedpm{52.78}{.13} & \seedpm{52.70}{.14} & \seedpm{52.76}{.04} & \seedpm{52.65}{.02} & \seedpm{52.70}{.08} \\
    \addlinespace
    \multicolumn{7}{@{}l}{\emph{SSIM vs GT}} \\
    \quad elev $\uparrow$ & \seedpm{0.9671}{.0004} & \seedpm{0.9674}{.0002} & \seedpm{0.9670}{.0006} & \seedpm{0.9674}{.0002} & \seedpm{0.9675}{.0002} & \seedpm{0.9674}{.0001} \\
    \quad range $\uparrow$ & \seedpm{0.9510}{.0008} & \seedpm{0.9516}{.0004} & \seedpm{0.9499}{.0027} & \seedpm{0.9519}{.0004} & \seedpm{0.9521}{.0004} & \seedpm{0.9519}{.0004} \\
    \quad azim $\uparrow$ & \seedpm{0.9610}{.0006} & \seedpm{0.9615}{.0003} & \seedpm{0.9606}{.0014} & \seedpm{0.9615}{.0003} & \seedpm{0.9616}{.0002} & \seedpm{0.9615}{.0003} \\
    \addlinespace
    \multicolumn{7}{@{}l}{\emph{per-pixel $R^2$ --- the tail}} \\
    \quad median $\uparrow$ & \seedpm{0.888}{.007} & \seedpm{0.891}{.006} & \seedpm{0.870}{.049} & \seedpm{0.888}{.009} & \seedpm{0.889}{.009} & \seedpm{0.889}{.007} \\
    \quad mean $\uparrow$ & \seedpm{$-1.17$}{.79} & \seedpm{$-0.88$}{.53} & \seedpm{$-3.71$}{4.34} & \seedpm{$+0.53$}{.19} & \seedpm{$\mathbf{+0.77}$}{.01} & \seedpm{$+0.73$}{.05} \\
    \quad $p_5$ $\uparrow$ & \seedpm{0.275}{.065} & \seedpm{0.284}{.021} & \seedpm{$-0.912$}{2.630} & \seedpm{0.355}{.008} & \seedpm{\textbf{0.394}}{.003} & \seedpm{0.377}{.012} \\
    \quad $p_1$ $\uparrow$ & \seedpm{$-14.88$}{11.38} & \seedpm{$-12.37$}{4.01} & \seedpm{$-50.17$}{70.98} & \seedpm{$-2.16$}{1.08} & \seedpm{$\mathbf{-0.45}$}{.06} & \seedpm{$-0.87$}{.35} \\
    \quad min $\uparrow$ & \seedpm{$-13.2$k}{3.3k} & \seedpm{$-12.2$k}{4.8k} & \seedpm{$-22.5$k}{11.5k} & \seedpm{$-4.4$k}{1.2k} & \seedpm{$-4.2$k}{0.2k} & \seedpm{$\mathbf{-4.1}$k}{0.1k} \\
    \addlinespace
    \multicolumn{7}{@{}l}{\emph{per-pixel cosine}} \\
    \quad median $\uparrow$ & \seedpm{0.965}{.004} & \seedpm{0.966}{.002} & \seedpm{0.966}{.002} & \seedpm{0.966}{.002} & \seedpm{0.966}{.002} & \seedpm{0.966}{.001} \\
    \quad mean $\uparrow$ & \seedpm{0.934}{.003} & \seedpm{0.936}{.001} & \seedpm{0.936}{.001} & \seedpm{0.935}{.001} & \seedpm{0.934}{.001} & \seedpm{0.934}{.001} \\
    \quad $p_1$ $\uparrow$ & \seedpm{0.588}{.011} & \seedpm{0.599}{.009} & \seedpm{0.601}{.007} & \seedpm{0.584}{.006} & \seedpm{0.574}{.007} & \seedpm{0.579}{.008} \\
    \bottomrule
    \end{tabular}
  \par\vspace{2pt}
  \parbox{0.90\textwidth}{\tiny\color{soft} \textbf{runs}: dual UNet-skip trunks $\cdot$ set-pred $\cdot$ Hungarian
   ...
   trunks) $\cdot$ parity twins. Column $=$ physics
   term at its best-scoring weight, plus the $w{=}1$ coherence arm; none $=$ the
   no-physics reference. Five seeded replicas per arm, cells mean $\pm$ seed std;
   held-out test, $5.0$\,M px; pixel $R^2$ min and its spread in thousands (k).
   \textbf{bold} $=$ best in row, marked only where best and worst differ by more
   than $5\%$. The typical pixel never moves (pixel $R^2$ median 0.888--0.891, cos
   med 0.965--0.966, SSIM in the fourth decimal on all three axes) --- the story is
   the tail: a handful of catastrophic pixels wreck the no-physics mean ($-1.17$,
   $p_1$ $-14.9$, min $-13.2$k), and the descriptor and covariance terms cap the
   blow-ups (covariance $w{=}0.05$: mean $+0.77$, $p_1$ $-0.45$, min $-4.2$k) while
   cutting the curve-metric seed spread up to ${\sim}5\times$. Coherence is NOT tail
   insurance --- at $w{=}1$ its tail is worse than the baseline (mean $-3.71$, min
   $-22.5$k): the Fourier-domain term shapes coherences, not pixel-domain outliers.
   The curve-level and SSIM blocks carry the headline claim: the gains that exist
   sit at the edge of combined seed noise.\par}
\end{frame}
