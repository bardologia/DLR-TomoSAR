...
\begin{frame}{Motivation: more area from the same flight time}
  \begin{columns}[c]
    \begin{column}{0.56\textwidth}
      ...
      \\[9pt]
      \begin{tikzpicture}[font=\scriptsize]
        \foreach \o in {-0.06,-0.03,0,0.03,0.06} \draw[ink!50,very thin] (0,{1.02+\o}) -- (2.2,{1.02+\o});
        \fill[ink!70] (0.76,1.02) -- ++(-0.15,0.055) -- ++(0.045,-0.055) -- ++(-0.045,-0.055) -- cycle;
        \node[font=\tiny,text=soft,anchor=west] at (2.30,1.02) {flight line: 29 passes};
        \draw[soft,thin,rounded corners=1pt,fill=black!2] (0,0) rectangle (2.2,0.62);
        \draw[black!6,step=0.11] (0.02,0.02) grid (2.18,0.60);
        \fill[accent!12] (0.76,0.96) -- (0.62,0.03) -- (0.90,0.03) -- cycle;
        \draw[accent!50,very thin] (0.76,0.96) -- (0.62,0.03);
        \draw[accent!50,very thin] (0.76,0.96) -- (0.90,0.03);
        \node[font=\tiny,text=accent!80,anchor=west] at (0.92,0.80) {side-looking beam};
        \node[font=\tiny,text=soft,anchor=north] at (1.10,-0.05) {one scene};
        \node[font=\scriptsize\bfseries,text=accent,anchor=west] at (2.85,0.40) {$\times\,5.8$ area};
        \foreach \o in {-0.025,0.025} \draw[ink!50,very thin] (0,{-0.72+\o}) -- (6.5,{-0.72+\o});
        \fill[ink!70] (6.12,-0.72) -- ++(-0.15,0.055) -- ++(0.045,-0.055) -- ++(-0.045,-0.055) -- cycle;
        \node[font=\tiny,text=soft,anchor=south west] at (0,-0.66) {flight line: 5 passes per scene};
        \foreach \x in {0,1.14,2.28,3.42,4.56} {
          \draw[soft,thin,rounded corners=1pt,fill=black!2] (\x,-1.74) rectangle ++(1.0,0.62);
          \draw[black!6,step=0.11] (\x+0.02,-1.72) grid (\x+0.98,-1.14);
        }
        \draw[soft,thin,densely dashed,fill=black!2] (5.70,-1.74) rectangle ++(0.80,0.62);
        \fill[accent!12] (6.12,-0.78) -- (5.98,-1.71) -- (6.26,-1.71) -- cycle;
        \draw[accent!50,very thin] (6.12,-0.78) -- (5.98,-1.71);
        \draw[accent!50,very thin] (6.12,-0.78) -- (6.26,-1.71);
        \node[font=\tiny,text=soft,anchor=north] at (3.25,-1.79) {$29/5 \approx 5.8$ scenes};
        \draw[decorate,decoration={brace,amplitude=4pt},soft] (-0.2,-1.74) -- (-0.2,1.08);
        \node[font=\tiny,text=soft,rotate=90,anchor=south] at (-0.42,-0.33) {same flight time};
      \end{tikzpicture}
    \end{column}
