  ...
  \begin{columns}[c]
    \begin{column}{0.56\textwidth}
      ...
      \begin{tikzpicture}[font=\scriptsize]
        ...
        \foreach \y in {0.08,0.145,...,0.56} \draw[accent!45,very thin] (0.06,\y) -- (2.14,\y);
        \fill[ink!70] (2.42,0.31) -- ++(-0.15,0.055) -- ++(0.045,-0.055) -- ++(-0.045,-0.055) -- cycle;
        \node[font=\tiny,text=soft,anchor=north] at (1.10,-0.05) {one scene: 29 passes};
        \node[font=\scriptsize\bfseries,text=accent,anchor=west] at (2.85,0.31) {$\times\,5.8$ area};
        \foreach \x in {0,1.14,2.28,3.42,4.56} {
          \draw[soft,thin,rounded corners=1pt,fill=black!2] (\x,-1.47) rectangle ++(1.0,0.62);
          \draw[black!6,step=0.11] (\x+0.02,-1.45) grid (\x+0.98,-0.87);
          \foreach \y in {-1.31,-1.16,-1.01} \draw[accent!45,very thin] (\x+0.06,\y) -- (\x+0.94,\y);
        }
        \draw[soft,thin,densely dashed,fill=black!2] (5.70,-1.47) rectangle ++(0.80,0.62);
        \foreach \y in {-1.31,-1.16,-1.01} \draw[accent!45,very thin] (5.76,\y) -- (6.42,\y);
        \fill[ink!70] (6.64,-1.16) -- ++(-0.15,0.055) -- ++(0.045,-0.055) -- ++(-0.045,-0.055) -- cycle;
        \node[font=\tiny,text=soft,anchor=north] at (3.25,-1.52) {$29/5 \approx 5.8$ scenes: 5 passes each};
        \draw[decorate,decoration={brace,amplitude=4pt},soft] (-0.2,-1.47) -- (-0.2,0.62);
        \node[font=\tiny,text=soft,rotate=90,anchor=south] at (-0.42,-0.425) {same flight time};
      \end{tikzpicture}
    \end{column}
