...
\begin{frame}{One encoder block: UNet vs UNet-skip vs ResUNet}
  \begin{columns}[T]
    \begin{column}{0.32\textwidth}
      \centering
      \begin{tikzpicture}[font=\scriptsize]
        \node[font=\small\bfseries] at (0.55,3.95) {UNet};
        \node[font=\tiny,text=soft] at (0.55,3.62) {board, L1-curve: 0.760};
        \node[font=\scriptsize] at (0.3,3.28) {$x$};
        ...
        \draw[flow,soft] (0.3,3.13) -- (c1.north);
    ...
    \begin{column}{0.32\textwidth}
      \centering
      \begin{tikzpicture}[font=\scriptsize]
        \node[font=\small\bfseries] at (0.55,3.95) {UNet-skip};
        \node[font=\tiny,text=soft] at (0.55,3.62) {board, L1-curve: 0.983};
        \node[font=\scriptsize] at (0.3,3.28) {$x$};
        ...
        \node[gate,minimum width=20mm,minimum height=5mm] (pool) at (0.3,-1.00) {MaxPool $2{\times}2$ $\downarrow 2$};
        \draw[flow,soft] (0.3,3.13) -- (n0.north);
        ...
        \draw[accent!80,thick] (0.3,3.10) -- (2.05,3.10) -- (sc.north);
    ...
    \begin{column}{0.32\textwidth}
      \centering
      \begin{tikzpicture}[font=\scriptsize]
        \node[font=\small\bfseries] at (0.55,3.95) {ResUNet};
        \node[font=\tiny,text=soft] at (0.55,3.62) {board, L1-curve: 0.930};
        \node[font=\scriptsize] at (0.3,3.28) {$x$};
        ...
        \node[gate,minimum width=20mm,minimum height=5mm] (c2) at (0.3,0.58) {Conv $3{\times}3$};
        \node[circle,draw=accent,inner sep=1.8pt,font=\scriptsize] (add) at (0.3,-0.16) {$+$};
        \node[gate,densely dashed,text=soft!70,minimum width=16mm,minimum height=5mm] (ghost) at (2.05,-1.00) {MaxPool};
