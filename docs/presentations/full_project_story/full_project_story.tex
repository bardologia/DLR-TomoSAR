...
\input{sections/01b_legacy_deltas}
...
\act{V \ \ Benchmark}{run-health tooling \; $\cdot$ \; every backbone $\times$ every objective \; $\cdot$ \; one winner \; $\cdot$ \; dual trunks \; $\cdot$ \; paired losses}
...
\input{sections/16_close}

\act{Backup}{}

\input{sections/17_backup}
