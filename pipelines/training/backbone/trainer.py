...
from pipelines.training.backbone.loss import Loss
from pipelines.training.backbone.docs import TrainingDocs
...
class Trainer(BaseTrainer):
    ...
    def maybe_run_loss_probe(self, train_loader, probe_config=None) -> None:
        ...
        from pipelines.training.backbone.docs import LossScaleProbe
