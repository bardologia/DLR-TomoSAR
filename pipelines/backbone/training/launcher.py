...
from pipelines.backbone.training.experiments import AblationTrialPlanner, ContextTrialPlanner, CurriculumTrialPlanner, InputTrialPlanner, PairLossTrialPlanner, PatchSizeTrialPlanner, PhysicsLossTrialPlanner, SecondaryTrialPlanner, SlotPresenceTrialPlanner, WarmupTrialPlanner
...
class TrainScheduler:
    ...
    SCHEDULER_FIELDS = ("trials_enabled", "trials_mode", "warmup_losses", "complete_losses", "presence_trials", "physics_trials", "pair_trials", "secondary_trials", "patch_trials", "input_trials", "context_trials", "ablation_features", "ablation_include_full", "gpus", "poll_interval_s")
    ...
    def planner(self):
        ...
        raise ValueError(f"Unknown trials_mode '{mode}', expected 'curriculum', 'warmup', 'presence', 'physics', 'pair', 'secondary', 'patch', 'input', 'context' or 'ablation'")
