...
from pipelines.inference.backbone.figures   import FigureComposer
from pipelines.inference.backbone.loader    import InferenceMetadata, RunLoader
from pipelines.inference.backbone.metrics   import Metrics
from pipelines.inference.backbone.plots     import Ploter
from pipelines.inference.backbone.predictor import Predictor
from pipelines.inference.backbone.report    import Report, ReportPayloadBuilder
...
class InferencePipeline:
    ...
    def _synthesize_reduced(self, cfg: InferenceConfig, meta: InferenceMetadata, run, result, x_axis_np: np.ndarray, global_metrics: dict, indices: dict, logger: Logger) -> None:
        ...
        from pipelines.inference.backbone.reduced import ReducedTomogramSynthesizer
